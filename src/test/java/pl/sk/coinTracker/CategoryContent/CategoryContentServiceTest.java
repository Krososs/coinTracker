...
class CategoryContentServiceTest {
    ...
    void should_return_content_by_id(){
        ...
        assertEquals(testService.getById(1L).getCoinId(),2L);
        assertEquals(testService.getById(1L).getCategoryId(),1L);
    }
    ...
    void should_return_content_by_category_id(){
        ...
        assertEquals(testService.getByCategoryId(1L).size(),2);
    }
